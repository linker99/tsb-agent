...
const std::string_view VIRT_XML_LOADER_PATH = "/domain/os/loader";
const std::string_view VIRT_XML_NAME_PATH = "/domain/name";
const std::string_view PATH_SEPARATOR = "/";
} // namespace
